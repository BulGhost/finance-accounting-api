...
namespace FinanceAccounting.Application.Tests.Users.Commands.RefreshToken
{
    public class RefreshTokenCommandHandlerTests
    {
        ...
        private readonly RefreshTokenModel _refreshToken = new() {UserId = _userId, IsUsed = false};
